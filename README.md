...
| MosMetro_Free | [NetByNet](http://www.netbynet.ru) | МЦК | :white_check_mark: | [MosMetro v2](/app/src/main/java/pw/thedrhax/mosmetro/authenticator/providers/MosMetroV2.java) |
...
| MT_FREE | [Enforta](http://www.enforta.ru/) | Остановки | :large_blue_circle: | [MosMetro v2](/app/src/main/java/pw/thedrhax/mosmetro/authenticator/providers/MosMetroV2.java) |
...
> Таблица сильно устарела. В данный момент классификация по SSID не имеет смысла, так как почти все сети пришли к единому названию "MT_FREE" и постепенно переходят у общему алгоритму, который в рамках этого проекта называется MosMetroV2.
